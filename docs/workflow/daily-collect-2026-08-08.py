...
# -*- coding: utf-8 -*-
"""
ROS2 기반 드론 최신 기술 일일 수집 (2026-08-08)
...
각 raw/articles/2026-08-08-*.md 파일에 frontmatter + sha256(body) 기록.
수집 후 docs/workflow/2026-08-08-ros2-drone-report.md 보고서 자동 생성.
"""
import json
import hashlib
import re
...
def main():
    ...
    print("\n=== 수집 완료 ===")
    print("수집된 데이터로 보고서 생성을 시작합니다...")
    
    # 실제 보고서는 별도의 스크립트에서 생성 (2026-08-08)
