...
# -*- coding: utf-8 -*-
"""
ROS2 기반 드론 최신 기술 일일 수집 (2026-08-07)
...
각 raw/articles/2026-08-07-*.md 파일에 frontmatter + sha256(body) 기록.
수집 후 docs/workflow/2026-08-07-ros2-drone-report.md 보고서 자동 생성.
"""
import json
import hashlib
import re
