...
# -*- coding: utf-8 -*-
"""
ROS2 기반 드론 최신 기술 일일 수집 (2026-08-14)
- GitHub Search API (9 쿼리, per_page=10, sort=stars)
- PX4 공식 문서 (docs.px4.io/main/en/)
- ROS2 공식 문서 (docs.ros.org/en/rolling/ — Anubis anti-bot 차단 가능)
- PX4 / ArduPilot 릴리즈 노트 (GitHub Releases API)
수집 후 docs/reports/2026-08-14-ros2-drone-report.md 보고서 자동 생성.
"""
import json
import hashlib
import re
...
def compute_sha256(body_text):
    """Compute SHA256 over the exact post-frontmatter body string."""
