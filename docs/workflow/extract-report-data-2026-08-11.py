#!/usr/bin/env python3
"""Extract key data from 2026-08-11 raw articles for report generation."""
import json
...
# 1. GitHub Data
gh = json.loads(read_body(f'{REPO}/raw/articles/2026-08-11-ros2-drone-github-data.md'))
...
# 2. PX4 Release Notes
px4_releases = json.loads(read_body(f'{REPO}/raw/articles/2026-08-11-px4-release-notes.md'))
print(f'\n=== PX4 Releases (top 6) ===')
for r in px4_releases[:6]:
    ...
    print(f'  body: {r.get("body","(no body)")[:300]}')
    print()

# 3. ArduPilot Release Notes
ap_releases = json.loads(read_body(f'{REPO}/raw/articles/2026-08-11-ardupilot-release-notes.md'))
...
# 4. PX4 Docs
px4_docs = read_body(f'{REPO}/raw/articles/2026-08-11-px4-docs-main.md')
print(f'\n=== PX4 Docs (first 800 chars) ===')
print(px4_docs[:800])

# 5. ROS2 Docs
ros2_docs = read_body(f'{REPO}/raw/articles/2026-08-11-ros2-docs-rolling.md')
print(f'\n=== ROS2 Docs (first 800 chars) ===')
print(ros2_docs[:800])
