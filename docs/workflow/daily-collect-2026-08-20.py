...
# -*- coding: utf-8 -*-
"""
ROS2 기반 드론 최신 기술 일일 수집 (2026-08-20)
...
def fetch_html(url):
    ...
    try:
        ...
        if e.code == 404:
            return f"404 Not Found - The requested URL was not found on this server."
        raise
...
def save_raw_article(filename, body, source_url, title, extra_fields=""):
    """
    Save a raw article file in the exact 2026-08-18 format.
