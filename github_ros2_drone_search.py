#!/usr/bin/env python3
"""
GitHub Search API script to collect ROS2 drone related data.
Search terms: ros2 drone detection, autonomous, navigation, PX4 bridge, YOLO, Zenoh, MediaPipe, SLAM, ArUco
"""
